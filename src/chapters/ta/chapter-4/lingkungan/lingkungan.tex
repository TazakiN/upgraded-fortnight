...
\begin{enumerate}
	...
	\item CPU: Intel Core i5-11400H (3 \textit{core} fisik dan 6 \textit{logical thread} dialokasikan untuk WSL2).
	\item Memori RAM: 16 GB (8 GB teralokasi untuk WSL2).
	\item Perangkat bantu pengembangan: Rust (\texttt{rustc 1.93.0}, \texttt{cargo 1.93.0}), Node.js \texttt{v24.13.0}, dan Docker \texttt{29.5.3}.
\end{enumerate}
...
\begin{enumerate}
	...
	\item Perangkat bantu: Docker \texttt{29.4.2}.
\end{enumerate}
