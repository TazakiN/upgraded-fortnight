...
Gambar~\ref{fig:legenda-dfd} menjelaskan notasi pemodelan DFD DecMed. Gambar~\ref{fig:dfd-decmed-level-0} dan Gambar~\ref{fig:dfd-decmed-level-1} masing-masing menyajikan DFD Level~0 dan Level~1 sebagai dasar penelusuran aliran data sistem.
...
Gambar~\ref{fig:dfd-decmed-level-0} dan Gambar~\ref{fig:dfd-decmed-level-1} menempatkan interaksi aktor, proses, dan penyimpanan sebagai acuan analisis keamanan berikutnya. Tabel~\ref{tab:dfd-external-entities} sampai Tabel~\ref{tab:dfd-dataflow-level-1} merinci elemen DFD yang ditampilkan pada gambar tersebut.
...
Tabel~\ref{tab:dfd-external-entities} menegaskan aktor dan sistem eksternal yang berinteraksi dengan DecMed pada batas sistem.
...
Tabel~\ref{tab:dfd-process} merangkum dekomposisi proses dari batas sistem hingga komponen inti penegakan akses dan pengelolaan RME.
...
Tabel~\ref{tab:dfd-data-store} menunjukkan lokasi penyimpanan yang memuat data sensitif, mulai dari cache sementara hingga \textit{state on-chain}.
...
Tabel~\ref{tab:dfd-dataflow-level-0} merangkum aliran data pada batas sistem DecMed.
...
Tabel~\ref{tab:dfd-dataflow-level-1} memperinci aliran antarkomponen yang menjadi acuan analisis ancaman STRIDE.
