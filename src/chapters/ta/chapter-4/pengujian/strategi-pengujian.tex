...
Pengujian kebutuhan fungsional diberi ID \texttt{PS-TA} dan dijalankan melalui skenario manual untuk memeriksa perilaku sistem dari sudut pandang aktor layanan kesehatan. Pengujian kebutuhan nonfungsional diberi ID \texttt{PU-TA} dan dijalankan melalui pengujian unit atau integrasi terhadap komponen token, segmentasi data, validasi akses, dan \textit{Server} PRE. Pengujian otomatis dijalankan dengan \texttt{cargo test} pada komponen yang relevan.
