...
Data rekam medis sensitif yang berukuran besar disimpan secara \textit{Off-Chain} (IPFS), sedangkan metadata kontrol akses dan log audit disimpan secara \textit{On-Chain} (IOTA).
