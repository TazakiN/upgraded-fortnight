...
Tabel~\ref{tab:daftar-rancangan-solusi} memastikan setiap solusi \texttt{S-TA} memiliki rancangan \texttt{R-TA} yang merealisasikannya, sehingga ketertelusuran dari analisis solusi ke spesifikasi rancangan tetap terjaga.
