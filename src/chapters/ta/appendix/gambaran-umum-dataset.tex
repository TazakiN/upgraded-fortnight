...
Tabel berikut menjabarkan metadata variabel Rekam Medis Elektronik yang diadopsi dari KMK No. HK.01.07/MENKES/1423/2022 untuk kasus Rawat Jalan \autocite{kemenkes1423-2022}.
...
\begin{longtable}{|p{4cm}|p{5cm}|p{5cm}|}
	...
	\multirow{4}{4cm}{Pemeriksaan Fisik}
	                       & Tanda Vital               & Tekanan Darah (mmHg), Nadi (x/mnt), Suhu (C), Nafas (x/mnt) \\ \cline{2-3}
	                       & Tingkat Kesadaran         & Alert, Voice, Pain, Unresponsive                            \\ \cline{2-3}
