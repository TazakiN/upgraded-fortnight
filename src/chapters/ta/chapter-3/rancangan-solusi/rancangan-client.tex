...
Rancangan client tidak menjadi bagian dari rancangan solusi utama, melainkan menjadi implikasi dari rancangan solusi yang telah dijelaskan pada subbab sebelumnya.

Pada DecMed, terdapat tiga \textit{client} utama, yaitu \textit{Patient Client}, \textit{Hospital Client}, dan \textit{Ministry Client}. Perubahan yang dibutuhkan pada rancangan \textit{client} adalah hanya pada \textit{Patient Client} dan \textit{Hospital Client} saja.
