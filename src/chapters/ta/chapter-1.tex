...
\begin{enumerate}
	...
	\item Validasi pada mekanisme \textit{break-glass} dibatasi pada verifikasi teknis berupa validasi IP jaringan dari fasilitas kesehatan; verifikasi kondisi medis aktual pasien berada di luar lingkup sistem.
	\item Pada keadaan darurat, diasumsikan bahwa data NIK dan Nama Pasien diketahui oleh tenaga medis yang meminta akses darurat.
\end{enumerate}
