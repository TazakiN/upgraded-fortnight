...
Panduan lebih rinci terkait isi dari Rekam Medis Elektronik diatur pada Keputusan Menteri Kesehatan (KMK) No. HK.01.07/MENKES/1423/2022 tentang Pedoman Variabel dan metadata pada Penyelenggaraan Rekam Medis Elektronik \autocite{kemenkes1423-2022}. Keputusan ini mengatur variabel dan metadata yang terdapat pada RME dengan data set yang terdiri dari:
...
Sebagai contoh untuk mendapatkan gambaran umum dari metadata, data set Rawat Jalan dapat dilihat pada Lampiran \ref{lampiran:metadata-rme}.
